(ns construction-supervision.advisor
  "SiteSupervisionAdvisor — proposes a construction-supervision
  operation (coordinate a crew task, clear a checklist item, operate
  near active equipment, clear a site for the next work phase) for a
  registered site. The advisor is swappable: `mock-advisor`
  ...
  of site provenance or active-equipment/phase-clearance risk;
  `construction-supervision.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :coordinate|:clear|:operate-near-active-equipment|:clear-site-for-next-phase
...
(def ^:private system-prompt
  "You are a construction-supervision advisor. Given a supervision
